...
function drawInsideSpaces(p_context, p_drawer, p_colourSet, p_solver) {
	var items = [DrawableColor(p_colourSet.openSquare)];
	...
	p_drawer.drawSpaceContents(p_context, items, seaSelection, p_solver.xLength, p_solver.yLength);
...
drawNumberClosure = function(p_solver, p_colourSet) {
	return function(p_x, p_y) {
		...
		if (supposedNumber != null) {
			return new DrawSpaceValue(supposedNumber, p_colourSet.standardWrite);
		}
		return null;
	}
}
