...
function main() {
	...
	purificator.configure({blockedSymbol : SYMBOL_ID.X , isBlockedDegradable : false}); // Note : possibility of passing isBlockedDegradable to false ; should be done later... ?
