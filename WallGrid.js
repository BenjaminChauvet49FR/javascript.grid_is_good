...
WallGrid.prototype.getWallR = function(p_x,p_y){return this.array[p_y][p_x].wallR;}
WallGrid.prototype.getWallD = function(p_x,p_y){return this.array[p_y][p_x].wallD;}
WallGrid.prototype.getWallU = function(p_x,p_y){return this.array[p_y-1][p_x].wallR;}
WallGrid.prototype.getWallL = function(p_x,p_y){return this.array[p_y][p_x-1].wallD;}
WallGrid.prototype.getState = function(p_x,p_y){return this.array[p_y][p_x].state;}
WallGrid.prototype.setWallR = function(p_x,p_y,p_state){this.array[p_y][p_x].wallR = p_state;this.isRegionGridValid=false;}
WallGrid.prototype.setWallD = function(p_x,p_y,p_state){this.array[p_y][p_x].wallD = p_state;this.isRegionGridValid=false;}
WallGrid.prototype.setWallU = function(p_x,p_y,p_state){this.array[p_y-1][p_x].wallR = p_state;this.isRegionGridValid=false;}
WallGrid.prototype.setWallL = function(p_x,p_y,p_state){this.array[p_y][p_x-1].wallD = p_state;this.isRegionGridValid=false;}
WallGrid.prototype.setState = function(p_x,p_y,p_state){this.array[p_y][p_x].state = p_state;this.isRegionGridValid=false;}
WallGrid.prototype.switchWallR = function(p_x,p_y){this.setWallR(p_x,p_y,switchedState(this.getWallR(p_x,p_y)));}
WallGrid.prototype.switchWallD = function(p_x,p_y){this.setWallD(p_x,p_y,switchedState(this.getWallD(p_x,p_y)));}
WallGrid.prototype.switchWallU = function(p_x,p_y){this.setWallU(p_x,p_y,switchedState(this.getWallU(p_x,p_y)));}
