...
const ACTION_ENTER_NUMBER = {id:2, htmlCaption:"Entrer un nombre"}; // Needs to coexist with 'open space'
const ACTION_PUT_BULB = {id:1, htmlCaption:"Placer ampoule"};
const ACTION_PUT_LIGHT = {id:1, htmlCaption:"Placer lumière"};
const ACTION_PUT_BLOCK = {id:2, htmlCaption:"Placer bloc"};
