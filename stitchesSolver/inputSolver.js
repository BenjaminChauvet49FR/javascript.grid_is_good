...
loadPuzzle = function(p_canvas,p_drawer,p_solver, p_loadedString){
	var loadedItem = stringToStitchesPuzzle(p_loadedString);
	p_solver.construct(loadedItem.wallArray, loadedItem.marginLeft, loadedItem.marginUp, loadedItem.boundNumber);
