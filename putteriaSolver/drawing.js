...
function drawInsideSpaces(p_context, p_drawer, p_colourSet, p_solver) {
	...
	p_drawer.drawSpaceContents(p_context, [DrawableX(p_colourSet.fixedColour), DrawableX(p_colourSet.notFixedColour)], drawXClosure(p_solver), p_solver.xLength, p_solver.yLength);
}
